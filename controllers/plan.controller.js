...
class PlanController {
  ...
  static async create(req, res) {
    try {
      const { nombre, precio, frecuencia, descripcion } = req.body;
      ...
      const planId = await Plan.create({ nombre, precio, frecuencia, descripcion });
  ...
  static async update(req, res) {
    try {
      ...
      const updated = await Plan.update(id, { nombre, precio, frecuencia, descripcion });
